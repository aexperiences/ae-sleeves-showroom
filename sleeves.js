...
(function (global) {
  ...
  var TIERS = {
    chair: { key:"chair", name:"Core", rank:1, mo:250, build:0,
    ...
    studio: { key:"studio", name:"Elite", rank:2, mo:650, build:0,
    ...
    grandsuite: { key:"grandsuite", name:"Mothership", rank:3, mo:1400, build:0,
...
(function (global) {
  ...
  var ID      = "sleeves";                        /* this product, in the store catalog */
