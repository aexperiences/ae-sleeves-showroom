/* mca-rtc.js — Ravenwood Tattoo Collective (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.SLEEVES_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.SleevesMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
